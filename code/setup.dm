...
#define TANK_LEAK_PRESSURE		(20.*ONE_ATMOSPHERE)	// Tank starts leaking
#define TANK_RUPTURE_PRESSURE	(30.*ONE_ATMOSPHERE) // Tank spills all contents into atmosphere

#define TANK_FRAGMENT_PRESSURE	(40.*ONE_ATMOSPHERE) // Boom 3x3 base explosion
#define TANK_FRAGMENT_SCALE	    (10.*ONE_ATMOSPHERE) // +1 for each SCALE kPa aboe threshold
								// was 2 atm

//#define CANISTER_LEAK_PRESSURE		(20.*ONE_ATMOSPHERE)	// Tank starts leaking
//#define CANISTER_RUPTURE_PRESSURE	(30.*ONE_ATMOSPHERE) // Tank spills all contents into atmosphere

//#define CANISTER_FRAGMENT_PRESSURE	(40.*ONE_ATMOSPHERE) // Boom 3x3 base explosion
//#define CANISTER_FRAGMENT_SCALE	    (10.*ONE_ATMOSPHERE) // +1 for each SCALE kPa aboe threshold
...
#define PHAZON			29 	// phazon madness
#define FUTA			30 	// futanari
...
var/list/accessable_z_levels = list("6" = 50,"3" = 5, "4" = 25, "7" = 50, "8" = 50)
