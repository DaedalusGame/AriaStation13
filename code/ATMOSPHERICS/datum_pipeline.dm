datum/pipeline
	...
	proc/temperature_interact_specific(modeled_temperature, modeled_heat_capacity, share_volume, thermal_conductivity)
		var/total_heat_capacity = air.heat_capacity()
		var/partial_heat_capacity = total_heat_capacity*(share_volume/air.volume)

		var/delta_temperature = air.temperature - modeled_temperature

		var/heat = thermal_conductivity*delta_temperature* \
			(partial_heat_capacity*modeled_heat_capacity/(partial_heat_capacity+modeled_heat_capacity))

		air.temperature -= heat/total_heat_capacity
		//modeled_location.temperature += heat/modeled_heat_capacity
