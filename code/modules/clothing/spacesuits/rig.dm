/obj/item/clothing/head/helmet/space/rig
	...
	var/on = 0
	itemcolor = "engineering" //Determines used sprites: rig[on]-[color] and rig[on]-[color]2 (lying down sprite)
...
/obj/item/clothing/head/helmet/space/rig/phazon
	name = "containment hardsuit helmet"
	icon_state = "rig0-phazon"
	item_state = "rig0-phazon"
	armor = list(melee = 40, bullet = 5, laser = 20,energy = 5, bomb = 35, bio = 100, rad = 120)
	itemcolor = "phazon"
	allowed = list()
...
/obj/item/clothing/suit/space/rig/phazon
	icon_state = "rig-phazon"
	item_state = "rig-phazon"
	slowdown = 5
	name = "containment hardsuit"
	armor = list(melee = 60, bullet = 10, laser = 30, energy = 5, bomb = 45, bio = 100, rad = 120)
	protective_temperature = 10000
