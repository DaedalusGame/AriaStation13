...
/obj/item/clothing/suit/alexjacket
	name = "wool-mammot jacket"
	desc = "The height of class."
	icon_state = "alexjacket"
	item_state = "alexjacket"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS

/obj/item/clothing/suit/dawson
	name = "brown jacket"
	desc = "The depth of class."
	icon_state = "dawson"
	item_state = "dawson"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS