...
/obj/item/projectile/temp
	...
	on_hit(var/atom/target, var/blocked = 0)//These two could likely check temp protection on the mob
		if(istype(target, /mob/living))
			...
			//world << "Freeze gun hit [target] with [temperature], setting bodytemp to [M.bodytemperature]"
		return 1
...
/obj/item/projectile/bullet/potato
	name ="potato"
	icon_state= "potato"
	damage = 10
	flag = "bullet"
	...
	on_hit(var/atom/target, var/blocked = 0)
		...
		if(T)
			new /obj/effect/decal/cleanable/potato_smudge(T)

		return 1

/obj/item/projectile/bullet/glass
	name ="glass"
	icon_state= "glass"
	damage = 8
	flag = "bullet"
...
/obj/item/projectile/bullet/rod
	name ="rod"
	icon_state= "rod"
	damage = 25
	flag = "bullet"
