/obj/item/weapon/gun/energy/temperature
	...
	load_into_chamber()
		if(..())
			var/obj/item/projectile/temp/T = in_chamber
			if(T && istype(T))
				T.temperature = temperature
				//world << "set temperature gun projectile to [temperature]"
			return 1
		else
			return 0
	...
	process()
		switch(temperature)
			if(0 to 100) charge_cost = 500
			if(100 to 250) charge_cost = 100
			if(251 to 300) charge_cost = 10
			if(301 to 400) charge_cost = 100
			if(401 to 500) charge_cost = 500
