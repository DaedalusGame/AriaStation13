...
/obj/item/weapon/reagent_containers/food/snacks/badrecipe
	...
	rotten
		name = "Rotten mass"
		desc = "Someone should've ordered the proper crates."
...
/obj/item/weapon/reagent_containers/food/snacks/icecream
	...
	New()
		..()
		reagents.add_reagent("nutriment", 6)
		reagents.add_reagent("ice", 3)
		bitesize = 3

/obj/item/weapon/reagent_containers/food/snacks/bloodcream
	name = "Blood Cream"
	desc = "Tasty! For vampires..."
	icon_state = "bloodcream"
	New()
		..()
		reagents.add_reagent("nutriment", 3)
		reagents.add_reagent("ice", 3)
		reagents.add_reagent("blood", 3)
		bitesize = 3

/obj/item/weapon/reagent_containers/food/snacks/chococream
	name = "Chocolate Cream"
	desc = "Tasty! The highest evolution of icecream in the dar'winistic universe."
	icon_state = "chococream"
	New()
		..()
		reagents.add_reagent("nutriment", 2)
		reagents.add_reagent("ice", 3)
