...
zone/proc/process()
	...
	if(air.toxins > MOLES_PLASMA_VISIBLE)
		...
		var/datum/gas/snow = locate(/datum/gas/snow) in air.trace_gases
		var/datum/gas/rain = locate(/datum/gas/rain) in air.trace_gases
		var/datum/gas/coolant = locate(/datum/gas/coolant) in air.trace_gases
