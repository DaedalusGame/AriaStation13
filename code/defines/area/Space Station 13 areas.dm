...
/area/hallway/secondary/exitpad
	name = "\improper Escape Shuttle Receptacle"
	icon_state = "escape"
	requires_power = 0
...
/area/teleporter
	name = "\improper Teleporter A"
	icon_state = "teleporter"
	music = "signal"

/area/teleporterarea0
	name = "\improper Teleporter B"
	icon_state = "teleporter"
	music = "signal"
...
/area/medical/medenter
	name = "Medbay Entrance"
	icon_state = "medbay"
	music = 'signal.ogg'

/area/medical/medcorr
	name = "Medbay Corridor"
	icon_state = "medbay"
	music = 'signal.ogg'

/area/medical/medbeds
	name = "Medbay Sickbeds"
	icon_state = "medbay"
	music = 'signal.ogg'

/area/medical/medcenter
	name = "Central Medbay"
	icon_state = "medbay"
	music = 'signal.ogg'
