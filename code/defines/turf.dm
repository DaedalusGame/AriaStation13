...
/turf/space/New()
	if(!istype(src, /turf/space/transit))
		..()
		if(istype(src, /turf/space/red))
			icon_state = "[x % 13],[y % 13]"
		else
...
/turf/simulated/floor/redcarpet
	name = "Red Carpet"
	icon_state = "rcarpet"
...
/turf/simulated/floor/securitile
	name = "Red Floor"
	icon_state = "redsecuritile"
	floor_tile = new/obj/item/stack/tile/plasteel

/turf/simulated/floor/area0
	name = "Futuristic Flooring"
	icon_state = "area-0"
	floor_tile = new/obj/item/stack/tile/plasteel

/turf/simulated/floor/plating/airless/scrap
	name = "Scrap"
	icon = 'scrapfloor.dmi'
	icon_state = "1"
