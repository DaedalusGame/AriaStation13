...
/obj/effect/sign/lettering
	desc = "A letter, how bland."
	name = "Lettering"
	icon = 'decals.dmi'
	icon_state = "typography-a"
	anchored = 1.0
	opacity = 0
	density = 0

/obj/effect/sign/lettering/security
	desc = "A letter, how bland."
	name = "Lettering"
	icon = 'decals.dmi'
	icon_state = "security-s"
	anchored = 1.0
	opacity = 0
	density = 0

/obj/effect/sign/lettering/security/cell
	desc = "A number, how bland."
	name = "Number"
	icon = 'decals.dmi'
	icon_state = "cell-1"
	anchored = 1.0
...
/obj/effect/sign/lettering/civil
	desc = "A letter, how bland."
	name = "Lettering"
	icon = 'decals.dmi'
	icon_state = "civil-c"
...
/obj/effect/sign/brig
	desc = "A warning sign which reads 'BRIG' there is a picture of an inmate attempting to bend bars, how futile."
	name = "BRIG"
	icon = 'decals.dmi'
	icon_state = "brig"
	anchored = 1.0
...
/obj/effect/sign/chapel
	desc = "A warning sign which reads 'CHAPEL'"
	name = "CHAPEL"
	icon = 'decals.dmi'
	icon_state = "chapel"
	anchored = 1.0
...
/obj/effect/sign/armory
	desc = "A warning sign which reads 'ARMORY', there is a footnote under it that says 'Warning : Violent raids are frequent.'"
	name = "ARMORY"
	icon = 'decals.dmi'
	icon_state = "armory"
	anchored = 1.0
...
/obj/effect/sign/security
	desc = "A warning sign which reads 'SECURITY', it shows an officer beating someone to death with a stun baton."
	name = "SECURITY"
	icon = 'decals.dmi'
	icon_state = "security"
	anchored = 1.0
...
/obj/effect/sign/courtroom
	desc = "A warning sign which reads 'COURTROOM'"
	name = "COURTROOM"
	icon = 'decals.dmi'
...
/obj/item/verb/verb_pickup()
	...
	if((!istype(usr, /mob/living/carbon)) || (istype(usr, /mob/living/carbon/brain)))//Is humanoid, and is not a brain
		...
		return
	if( usr.stat || usr.restrained() || usr.frozen)//Is not asleep/dead and is not restrained
		usr << "\red You can't pick things up!"
		return
...
/obj/item/indent_frame
	name = "indent frame"
	desc = "A form used for slicing indents into walls"
	icon = 'indent.dmi'
	icon_state = "build"
	flags = FPRINT | TABLEPASS| CONDUCT
...
/obj/item/metroid_core
	...
	phazon
		name = "phazon core"
		desc = "A metroid core gone horribly wrong."
		icon_state = "phazon core"
...
/obj/item/stack/sheet/circuit
	name = "system-integrity circuits"
	singular_name = "system-integrity circuit"
	desc = "This circuit is integral to the stability of the ship's AI processor core.."
	icon_state = "sheet-circuit"
	m_amt = 4500
	g_amt = 4500
	throwforce = 15.0
	flags = FPRINT | TABLEPASS | CONDUCT
