...
/obj/effect/decal/cleanable/blood/gibs/frost
	name = "frozen gibs"
	desc = "They look bloody and gruesome. And frozen."
	gender = PLURAL
	density = 0
	anchored = 0
	layer = 2.98
	icon = 'blood.dmi'
	icon_state = "icegib1"
	random_icon_states = list("icegib1", "icegib2", "icegib3")

/obj/effect/decal/cleanable/blood/gibs/frost/body
	random_icon_states = list("icegib4")

/obj/effect/decal/cleanable/blood/gibs/frost/limb
	random_icon_states = list("icegib1")

/obj/effect/decal/cleanable/blood/gibs/frost/down
	random_icon_states = list("icegib2")
...
/obj/effect/decal/cleanable/potato_smudge
	name = "potato smudge"
	desc = "It's potato."
	density = 0
	anchored = 1
	layer = 2
	icon = 'tomatodecal.dmi'
	random_icon_states = list("potato_floor1", "potato_floor2", "potato_floor3")
