...
/obj/machinery/door/airlock/glass_single
	name = "Door"
	icon = 'Doorglassone.dmi'
	opacity = 0
	doortype = 31
	glass = 1

/obj/machinery/door/airlock/metal_single
	name = "Heavy Door"
	icon = 'Doormetalone.dmi'
	opacity = 1
	doortype = 32
	forcecrush = 1
	holdopen = 0

/obj/machinery/door/airlock/grate
	name = "External Door"
	icon = 'Doorgrate.dmi'
	opacity = 0
	doortype = 33
...
/obj/machinery/door/airlock/animatedoor(animation)
	switch(animation)
		if("opening")
			if(overlays) overlays = null
			if(p_open)
