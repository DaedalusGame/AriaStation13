...
/datum/cargoprofile/boxes
	...
	id = "boxes"
	blacklist = null
	whitelist = list(/obj/item/weapon/storage, /obj/item/weapon/trashbag, /obj/item/weapon/plantbag,
					/obj/item/weapon/moneybag,/obj/item/weapon/evidencebag,/obj/item/weapon/tray,
					/obj/item/weapon/pizza_box,/obj/item/weapon/clipboard,
...
/datum/cargoprofile/supplies
	...
	whitelist = list(/obj/item/weapon/cable_coil,/obj/item/stack/rods,
					...
					/obj/item/weapon/table_parts,/obj/item/scrapblock)
...
/datum/cargoprofile/exotics
	...
	id = "exotics"
	blacklist = null
	whitelist = list(/obj/item/weapon/coin,
...
/datum/cargoprofile/organics
	...
	id = "organics"
	blacklist = null
	whitelist = list(/obj/item/brain,/obj/item/weapon/tank,/obj/item/weapon/reagent_containers,
					/obj/item/stack/medical,/obj/item/weapon/storage/pill_bottle,/obj/item/weapon/gun/syringe,
					/obj/item/weapon/plastique,/obj/item/weapon/chem_grenade,/obj/item/ammo_magazine,
...
/datum/cargoprofile/food
	...
	whitelist = list(/obj/item/weapon/reagent_containers/food,/obj/item/gibblock)
...
/datum/cargoprofile/chemical
	...
	whitelist = list(/obj/item/weapon/reagent_containers,/obj/item/stack/medical,/obj/item/weapon/storage/pill_bottle,
					/obj/item/weapon/gun/syringe,/obj/item/weapon/chem_grenade,/obj/item/weapon/dnainjector,
...
/datum/cargoprofile/trash
	...
	blacklist = null
	whitelist = list(/obj/item/scrap,/obj/item/trash,/obj/item/toy,/obj/item/weapon/ectoplasm,/obj/item/weapon/bananapeel/*,/obj/item/weapon/broken_bottle*/,/obj/item/weapon/bikehorn,
					/obj/item/weapon/cigbutt,/obj/item/weapon/contraband,/obj/item/weapon/corncob,/obj/item/weapon/paper,/obj/item/weapon/shard,
					/obj/item/weapon/directions,/obj/item/weapon/paperscrap,/obj/item/weapon/photo,/*/obj/item/weapon/folder*/
...
/datum/cargoprofile/scrap
	name = "Recyclable Scrap"
	id = "scrap"
	//Note that this filters out blueprints because they are a paper item.  Do NOT throw out the station blueprints unless you be trollin'.
	blacklist = null
	whitelist = list(/obj/item/scrap,/obj/effect/decal/cleanable/blood/gibs)
...
/datum/cargoprofile/weapons
	...
	whitelist = list(/obj/item/weapon/banhammer,/obj/item/weapon/syndie,/obj/item/weapon/butch,/obj/item/weapon/claymore,
					/obj/item/weapon/flamethrower,/obj/item/weapon/chem_grenade,/obj/item/weapon/gun,/obj/item/weapon/hatchet,/obj/item/weapon/melee,
...
/datum/cargoprofile/tools
	...
	whitelist = list(/obj/item/device,/obj/item/weapon/card,/obj/item/weapon/cartridge,/obj/item/weapon/cautery,/obj/item/weapon/cell,/obj/item/weapon/circuitboard,
					/obj/item/weapon/aiModule,/obj/item/weapon/airlock_electronics,/obj/item/weapon/circular_saw,
					/obj/item/weapon/cloaking_device,/obj/item/weapon/crowbar,/obj/item/weapon/disk,/obj/item/weapon/hand_tele,
					...
					/obj/item/weapon/packageWrap,/obj/item/weapon/reagent_containers/glass/paint,/obj/item/weapon/pen,/obj/item/weapon/pickaxe,/obj/item/weapon/pinpointer,
...
/datum/cargoprofile/seedboxer
	...
	outlet_reaction(var/atom/W,var/turf/D)
		...
		for(var/obj/item/weapon/storage/box/B in D.contents)
			if(B.name == "Seed box ([S.plantname])" && B.contents.len < B.storage_slots)
				S.loc = B
				return
		//No such box or all boxes full
		var/obj/item/weapon/storage/box/B = new(D)
		B.name = "Seed box ([S.plantname])"
		B.tag = S.type
		B.foldable = /obj/item/weapon/paperscrap // no, you cannot have infinite cardboard or boxes
		S.loc = B
...
/datum/cargoprofile/unary/shredder
	...
	id = "shredder"
	blacklist = null
	whitelist = list(/obj/item/weapon/paper,/obj/item/weapon/book,/obj/item/weapon/clipboard,/*/obj/item/weapon/folder,*//obj/item/weapon/photo,/obj/item/weapon/paperscrap)
	universal = 1

	outlet_reaction(var/atom/W,var/turf/D)
		if(istype(W,/obj/item/weapon/paperscrap))
			del W
			return
		if(istype(W,/obj/item/weapon/clipboard) /*|| istype(W,/obj/item/weapon/folder)*/)
			...
			for(var/obj/item/I in W.contents)
				if(prob(25))//JUNK IT
					...
					var/obj/item/weapon/paperscrap/P = new(master.loc)
					P.name = I.name
					//todo: transfer some amount of data from the old item
					del I
					..(P,D)
				else
					..(I,D) // Eject
...
/datum/cargoprofile/massdriver
	name = "Massdriver-Loading"
	id = "massdriver"
...
/datum/cargoprofile/people
	...
	whitelist = null
	blacklist = list(/mob/aiEye,/mob/new_player,/mob/living/blob,
					/mob/living/simple_animal/space_worm,/mob/living/simple_animal/shade,/mob/dead)
	universal = 1
	mobcheck = 1
