...
/obj/structure/closet/secure_closet/fridge/close()
	..()

	if(air_contents)
		air_contents.temperature = 277.15

/obj/structure/closet/secure_closet/meat/close()
	..()

	if(air_contents)
		air_contents.temperature = 277.15

/obj/structure/closet/secure_closet/money_freezer/close()
	..()

	if(air_contents)
		air_contents.temperature = 270.0
...
/obj/structure/closet/proc/open()
	...
	src.air_contents = null //Good Luck, GC
...
/obj/structure/closet/proc/close()
	...
	if(environment)
		air_contents = new()
		air_contents.copy_from(environment)
