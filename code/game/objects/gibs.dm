...
/proc/fgibs(atom/location, var/list/viruses, var/datum/dna/MobDNA)
	new /obj/effect/gibspawner/frost(get_turf(location),viruses,MobDNA)
...
/obj/effect/gibspawner
	...
	frost
		gibtypes = list(/obj/effect/decal/cleanable/blood/gibs/frost/down,/obj/effect/decal/cleanable/blood/gibs/frost,/obj/effect/decal/cleanable/blood/gibs/frost/body,/obj/effect/decal/cleanable/blood/gibs/frost/limb,/obj/effect/decal/cleanable/blood/gibs,/obj/item/weapon/reagent_containers/food/snacks/bloodcream,/obj/item/weapon/reagent_containers/food/snacks/icecream)
		gibamounts = list(1,1,1,1,1,1,1)

		New()
			gibdirections = list(list(NORTH, NORTHEAST, NORTHWEST),list(SOUTH, SOUTHEAST, SOUTHWEST),list(WEST, NORTHWEST, SOUTHWEST),list(EAST, NORTHEAST, SOUTHEAST), alldirs, alldirs, list())
			gibamounts[5] = pick(1,2,3)
			gibamounts[6] = pick(0,1,2)
			gibamounts[7] = pick(0,1,2)
			..()