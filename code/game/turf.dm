...
/turf/proc/ReplaceWithSpace()
	...
	var/turf/space/S
	if(src.z == 5)
		S = new /turf/space/red( locate(src.x, src.y, src.z) )
	else
		S = new /turf/space( locate(src.x, src.y, src.z) )
	S.dir = old_dir
...
/turf/simulated/wall/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	else if(istype(W,/obj/item/indent_frame))
		var/obj/item/indent_frame/IF = W
		IF.try_build(src)
		return
...
/turf/simulated/floor/bluegrid
	icon = 'floors.dmi'
	icon_state = "bcircuit"
	floor_tile = new/obj/item/stack/sheet/circuit
...
/turf/simulated/floor/wood
	name = "floor"
	icon_state = "wood"
	floor_tile = new/obj/item/stack/sheet/wood