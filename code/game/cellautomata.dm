...
//	coffinhandler = new /datum/coffinhandler()
	...
	snmaster = new /obj/effect/overlay(  )
	snmaster.icon = 'tile_effects.dmi'
	snmaster.icon_state = "snow"
	snmaster.layer = FLY_LAYER
	snmaster.mouse_opacity = 0

	rnmaster = new /obj/effect/overlay(  )
	rnmaster.icon = 'tile_effects.dmi'
	rnmaster.icon_state = "rain"
	rnmaster.layer = FLY_LAYER
	rnmaster.mouse_opacity = 0

	clmaster = new /obj/effect/overlay(  )
	clmaster.icon = 'tile_effects.dmi'
	clmaster.icon_state = "coolant"
	clmaster.layer = TURF_LAYER
