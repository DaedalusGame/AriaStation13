	...
	switch(job)
		...
		if("Station Engineer")
			return list(ACCESS_ENGINE, ACCESS_ENGINE_EQUIP, ACCESS_TECH_STORAGE, ACCESS_MAINT_TUNNELS, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_CONSTRUCTION,
			            ACCESS_MINING_STATION,ACCESS_MINING)
		if("Assistant")
		...
		if("Scientist")
			return list(ACCESS_MEDICAL,ACCESS_CHEMISTRY,ACCESS_TOX, ACCESS_TOX_STORAGE, ACCESS_RESEARCH,ACCESS_TELEPORTER,ACCESS_MINING_STATION,ACCESS_MINING, ACCESS_XENOBIOLOGY)
		if("Head of Security")
		...
		if("Atmospheric Technician")
			return list(ACCESS_ENGINE, ACCESS_ATMOSPHERICS, ACCESS_MAINT_TUNNELS, ACCESS_EMERGENCY_STORAGE,
			            ACCESS_MINING_STATION,ACCESS_MINING)
		if("Bartender")
			return list(ACCESS_KITCHEN, ACCESS_BAR)
		if("Chemist")
		...
		if("Roboticist")
			return list(ACCESS_ROBOTICS,ACCESS_RESEARCH,ACCESS_MEDICAL,ACCESS_ENGINE, ACCESS_TECH_STORAGE, ACCESS_MAINT_TUNNELS, ACCESS_MORGUE,
			            ACCESS_MINING_STATION,ACCESS_MINING) //As a job that handles so many corpses, it makes sense for them to have morgue access.
		if("Cargo Technician")
			return list(ACCESS_MAINT_TUNNELS, ACCESS_CARGO, ACCESS_CARGO_BOT, ACCESS_MAILSORTING)
		if("Shaft Miner")
			return list( ACCESS_MINT, ACCESS_MINING_STATION,ACCESS_MINING, ACCESS_TELEPORTER)
		if("Quartermaster")
			return list(ACCESS_MAINT_TUNNELS, ACCESS_MAILSORTING, ACCESS_CARGO, ACCESS_CARGO_BOT, ACCESS_QM, ACCESS_MINT, ACCESS_MINING, ACCESS_MINING_STATION, ACCESS_TELEPORTER)
		if("Chief Engineer")
			return list(ACCESS_ENGINE, ACCESS_ENGINE_EQUIP, ACCESS_TECH_STORAGE, ACCESS_MAINT_TUNNELS,
			            ACCESS_TELEPORTER, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_ATMOSPHERICS, ACCESS_EMERGENCY_STORAGE, ACCESS_EVA,
			            ACCESS_HEADS, ACCESS_AI_UPLOAD, ACCESS_CONSTRUCTION, ACCESS_ROBOTICS,
			            ACCESS_MINT, ACCESS_CE, ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH,ACCESS_MINING_STATION,ACCESS_MINING, ACCESS_TCOMSAT)
		if("Research Director")
			return list(ACCESS_RD, ACCESS_HEADS, ACCESS_TOX, ACCESS_GENETICS,
			            ACCESS_TOX_STORAGE, ACCESS_TELEPORTER,
			            ACCESS_RESEARCH,ACCESS_CHEMISTRY, ACCESS_ROBOTICS,ACCESS_MEDICAL, ACCESS_XENOBIOLOGY,
